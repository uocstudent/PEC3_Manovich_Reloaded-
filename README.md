...
> En su libro — [**El Lenguaje de los Nuevos Medios**](https://uea1arteycomunicacion.files.wordpress.com/2013/09/manovich-el-legunaje-de-los-nuevos-medios.pdf), Manovich plantea que los medios se basan en **la representación numérica, la modularidad, la automatización, la variabilidad y transcodificación**, además sostiene que los medios emergentes, como el cine, la realidad virtual o las interfaces digitales, brindan una forma innovadora de percibir y experimentar el mundo. De manera análoga el **uso de gafas** para mejorar nuestra visión, estos nuevos medios proporcionan un conjunto de lentes conceptuales que moldean la percepción y comprensión del entorno digital. Estas "gafas de Manovich" influyen en nuestra interacción con la información e interpretación de los datos. (Lev Manovich, El Lenguaje de los Nuevos Medios 2001, p. 72).

En este sentido, TikTok podría considerarse como una expresión de las "gafas" de Manovich, ya que ofrece a los usuarios una forma específica de ver y experimentar el contenido visual. La plataforma utiliza algoritmos y tecnologías de compresión para codificar los videos en formato digital. Estos videos se almacenan en servidores y se distribuyen a través de la red. A su vez, también permite crear y editar videos de manera modular, combinando diferentes elementos como música, efectos visuales y fragmentos de otros videos. Esta capacidad de combinación modular es una característica clave de los nuevos medios digitales. 
