...
En este sentido, Tik Tok también se relaciona con la metáfora de las "gafas" de Manovich, ya que ofrece a los usuarios una forma específica de ver y experimentar el contenido visual. La plataforma utiliza algoritmos y tecnologías de compresión para codificar los videos en formato digital. Estos videos se almacenan en servidores y se distribuyen a través de la red. A su vez, permite crear y editar videos de manera modular, combinando diferentes elementos como música, efectos visuales y fragmentos de otros videos. Esta capacidad de combinación modular es una característica clave de los nuevos medios digitales. 
